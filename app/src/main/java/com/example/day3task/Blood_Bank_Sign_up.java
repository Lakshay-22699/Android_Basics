...
public class Blood_Bank_Sign_up extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        e1=findViewById(R.id.bbgnupname);
        e2=findViewById(R.id.bbsgnupno);
        e3=findViewById(R.id.bbsgnupmail);
        e4=findViewById(R.id.bbsgnupadd);
        e5=findViewById(R.id.bbsgnupbgrp);
        e6=findViewById(R.id.bbsgnuplastblooddate);
        e7=findViewById(R.id.bbsgnupdob);
        b1=findViewById(R.id.bbsgnsubmit);
        rg1=findViewById(R.id.bbrg);
        c1=findViewById(R.id.bbcheckBox);
        i1=findViewById(R.id.bbsgnimgvw);
        ...
        e7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(Blood_Bank_Sign_up.this,date,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),
    ...
    public void bbsgnup(View view) {
        if(c1.isChecked()) {
            ...
            editor.putString("bbname",s[0]);
            editor.putString("bbnumber",s[1]);
            editor.putString("bbmail",s[2]);
            editor.putString("bbadd",s[3]);
            editor.putString("bbbgrp",s[4]);
            editor.putString("bblbdg",s[5]);
            editor.putString("bbdob",s[6]);
            editor.putString("bbgender",s[7]);
            editor.commit();
...
//            else {
                ...
                Intent obj = new Intent(Blood_Bank_Sign_up.this, Common_Bgrp.class);
...
//            }
    ...
    public void stcon()
    {
        ...
        if (selectedId <= 0) {
            Toast.makeText(Blood_Bank_Sign_up.this, "Select Gender", Toast.LENGTH_LONG).show();
        }
        else {
